...
<html>
    ...
    <head>
        ...
        <title>დაგემილი: მთავარი გვერდი</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
                    <div class="container-fluid">
                        ...
                        <a class="btn btn-primary" href="goForPlannedDataUpload.htm" style="font-size: 20px;background-color: green">ახალი მონაცემების ატვირთვა</a>
