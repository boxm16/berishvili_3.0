...
@Repository
public class NewActualDataUploadDao {
    ...
    public String insertRoute(Route route) {
        try {
            ...
            for (Map.Entry<String, Day> dayEntry : days.entrySet()) {
                ...
                for (Map.Entry<Short, Exodus> exodusEntry : exoduses.entrySet()) {
                    ...
                    for (Map.Entry<String, TripVoucher> tripVoucherEntry : tripVouchers.entrySet()) {
                        ...
                        tripVoucherInsertionPreparedStatement.setString(2, route.getNumber());
            ...
            Logger.getLogger(NewActualDataUploadDao.class.getName()).log(Level.SEVERE, null, ex);
