        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <c:forEach var="routeNumber" items="${plannedRoutesSummaryPager.routeNumbers}"  >
                        <li >
                            <a href="plannedRoutesSummaryRequest.htm?requestedRoute=${routeNumber}">${routeNumber}</a>
                        </li>
                    </c:forEach>
                </ul>
            </nav>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
                    <div class="container-fluid">
                        ...
                        <center>
                            ${plannedRoutesSummaryPager.getDisplay()}
                        </center>
                    ...
                    <tbody>
                        <tr>
                            <td colspan='16' align="center">
                                მარშრუტ #: ${plannedRoutesSummary.number}
                            </td>
                        </tr>
                        <c:forEach var="day" items="${plannedRoutesSummary.days}">
                            ...
                            <c:forEach var="exodus" items="${day.value.exoduses}">
                                ...
                                <c:forEach var="tripVoucher" items="${exodus.value.tripVouchers}">
                                    <tr>
                                        ...
                                        <td>
                                            ${tripVoucher.value.number}
                                        </td>
                                        <td>
                                            ${tripVoucher.value.shift}
                                        </td>

                                        <td>
                                            ${tripVoucher.value.tripPeriodsTotal}
                                        </td>
                                        <td>
                                            ${tripVoucher.value.kilometrage}
                                        </td>
                                    </tr>
                                </c:forEach>
                            </c:forEach>
                ...
                <center>
                    ...
                    ${plannedRoutesSummaryPager.display}
